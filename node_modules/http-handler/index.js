...
var retrieveDocumentsByTitleJSON = function (successCb, failureCb, args) {
  var keyword = args['keyword'];
    ...
    // Configure the request
    var options = {
        url: "http://129.128.184.88/api/getDocumentsByTitle/start/0/count/99/" + keyword,
        headers: headers,
    }
...
var retrieveInstitutionTestJSON = function (successCb, failureCb, args) {
  var keyword = args['keyword'];
    console.log(keyword)
      // Set the headers
    var headers = {
    ...
    // Configure the request
    var options = {
        url: "http://129.128.184.88/api/getBasicInstitutionInfo/start/0/count/1/" + "canada",
        headers: headers,
    }
    console.log(options.url)
    // Start the request
...
var testAuthentication = function (successCb, failureCb, args) {
  ...
  retrieveDocumentsByTitleNoPageJSON(successCb2, errorCb2, {'keyword': ""});

}

exports.testAuthentication = testAuthentication;
exports.retrieveInstitutionJSON = retrieveInstitutionJSON;
exports.retrieveInstitutionTestJSON = retrieveInstitutionTestJSON
